...
class TestFindTestFile:
    ...
    def test_non_matching_path_frontend(self):
...
class TestCalculateTargetLines:
    ...
    def test_medium_large_files(self):
...
class TestGetTargetedTestCommand:
    ...
    def test_nested_path_with_test_file(self):
    ...
    def test_direct_app_path_with_test_file(self):
