...
class TestDetectMagicStrings:
    ...
    def test_detect_project_names(self):
...
"""
    ...
    def test_detect_legacy_models(self):
...
"""
    ...
    def test_exclude_pattern_project_names_in_markdown(self):
    ...
    def test_exclude_pattern_project_names_in_tests(self):
    ...
    def test_exclude_pattern_hardcoded_paths_in_json(self):
    ...
    def test_exclude_pattern_urls_in_tests(self):
    ...
    def test_legacy_models_not_excluded(self):
