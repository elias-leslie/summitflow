...
def test_task_branch_touched_frontend_detects_frontend_diff(monkeypatch) -> None:
    from cli.commands.done_lifecycle import _task_branch_touched_frontend
    ...
    assert _task_branch_touched_frontend("task-123", "summitflow", base_branch="main") is True


def test_task_branch_touched_frontend_ignores_backend_only_diff(monkeypatch) -> None:
    from cli.commands.done_lifecycle import _task_branch_touched_frontend
    ...
    assert _task_branch_touched_frontend("task-123", "summitflow", base_branch="main") is False


def test_task_branch_touched_frontend_skips_projects_without_frontend_service(monkeypatch) -> None:
    from cli.commands.done_lifecycle import _task_branch_touched_frontend
