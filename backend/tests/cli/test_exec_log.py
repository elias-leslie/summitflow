...
class TestSubtaskSummary:
    ...
    def test_in_progress_indicator(self):
...
class TestExecLogCommand:
    ...
    def test_exec_log_compact_output(self, mock_client):
    ...
    def test_exec_log_human_readable(self, mock_client):
    ...
    def test_exec_log_json_output(self, mock_client):
    ...
    def test_exec_log_invalid_task_id(self):
    ...
    def test_exec_log_limit_option(self, mock_client):
    ...
    def test_exec_log_debug_option(self, mock_client):
...
class TestExecMonitorAlias:
    ...
    def test_exec_monitor_alias_exists(self):
