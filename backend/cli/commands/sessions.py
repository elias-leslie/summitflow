...
_normalize_status_filter = _SessionHelpers._normalize_status_filter
_session_matches_status_alias = _SessionHelpers._session_matches_status_alias
_live_state = _SessionHelpers._live_state
_compact_session_line = _SessionHelpers._compact_session_line
_render_session_list = _SessionHelpers._render_session_list
_session_field = _SessionHelpers._session_field
_live_activity_summary = _SessionHelpers._live_activity_summary
_live_activity_command = _SessionHelpers._live_activity_command
_live_activity_files = _SessionHelpers._live_activity_files
_live_activity_reason_codes = _SessionHelpers._live_activity_reason_codes
_live_activity_quiet = _SessionHelpers._live_activity_quiet
_live_activity_error = _SessionHelpers._live_activity_error
_monitor_more = _SessionHelpers._monitor_more
_monitor_detail_more = _SessionHelpers._monitor_detail_more
_reapable_session_payload = _SessionHelpers._reapable_session_payload
_monitor_summary = _SessionHelpers._monitor_summary
_monitor_summary_fields = _SessionHelpers._monitor_summary_fields
_empty_monitor_summary = _SessionHelpers._empty_monitor_summary
...
_monitor_task_target = _MonitorHelpers._monitor_task_target
_render_monitor_sessions = _MonitorHelpers._render_monitor_sessions
_monitor_project_flag = _MonitorHelpers._monitor_project_flag
_recent_session_events = _MonitorHelpers._recent_session_events
_event_text = _MonitorHelpers._event_text
_event_signature = _MonitorHelpers._event_signature
_is_error_like = _MonitorHelpers._is_error_like
_diagnostic_rows = _MonitorHelpers._diagnostic_rows
_render_session_diagnostics = _MonitorHelpers._render_session_diagnostics
_diagnostic_header = _MonitorHelpers._diagnostic_header
_print_diagnostic_rows = _MonitorHelpers._print_diagnostic_rows
_monitor_single_session = _MonitorHelpers._monitor_single_session
_list_monitor_sessions = _MonitorHelpers._list_monitor_sessions
_monitor_overview = _MonitorHelpers._monitor_overview
_render_or_output_monitor_sessions = _MonitorHelpers._render_or_output_monitor_sessions
...
class _MonitorActiveHelpers:
    def _monitor_active_sessions(
        *,
        project_id: str | None,
        status_filter: str,
        limit: int,
...
_monitor_active_sessions = _MonitorActiveHelpers._monitor_active_sessions
...
_list_all_active_sessions = _ReapHelpers._list_all_active_sessions
_reapable_sessions = _ReapHelpers._reapable_sessions
_output_dry_run = _ReapHelpers._output_dry_run
...
_close_reapable_sessions = _ReapCloseHelpers._close_reapable_sessions
_reapable_session_failure = _ReapCloseHelpers._reapable_session_failure
