...
# ─── Hatchet ──────────────────────────────────────────────────
# Signing keys live in the hatchet-config Docker volume.
# Tokens stay valid as long as the volume persists.
...
# Method 1: Generate a temp token (hatchet auto-selects the default tenant)
