  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'sunset-gradient':
          'linear-gradient(180deg, #fff200 0%, #ff6600 50%, #ff0066 100%)',
      },
      backgroundSize: {
        grid: '24px 24px',
      },
      boxShadow: {
        outrun:
          '0 0 20px rgba(255, 0, 102, 0.3), 0 0 40px rgba(255, 0, 102, 0.1)',
        'outrun-sm': '0 0 10px rgba(255, 0, 102, 0.25)',
        'outrun-lg':
          '0 0 30px rgba(255, 0, 102, 0.4), 0 0 60px rgba(255, 0, 102, 0.2)',
        sunset:
          '0 0 20px rgba(255, 102, 0, 0.3), 0 0 40px rgba(255, 0, 102, 0.2)',
      },
    },
  },
  plugins: [],
