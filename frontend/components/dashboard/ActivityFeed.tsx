...
type ActivityType = "task_complete" | "file_scanned" | "feature_updated" | "health_check" | "commit" | "chat";
...
const activityIcons: Record<ActivityType, { icon: React.ElementType; color: string }> = {
  task_complete: { icon: CheckCircle2, color: "text-green-400 bg-green-500/10" },
