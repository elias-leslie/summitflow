...
export const STATUS_CONFIG = {
  active: { label: 'Active', color: 'text-sky-300', bg: 'bg-sky-500/10', border: 'border-sky-500/30' },
  ...
  archived: { label: 'Archived', color: 'text-slate-500', bg: 'bg-slate-800/50', border: 'border-slate-700/40' },
} as const
