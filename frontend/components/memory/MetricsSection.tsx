    ...
    return (
      <div className="grid grid-cols-4 gap-4 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="bg-slate-800/50 rounded-xl p-5 animate-pulse h-28"
          />
        ))}
      </div>
    )
  ...
  return (
    <div className="grid grid-cols-4 gap-4 mb-8">
      <MetricCard
        ...
        subtitle={`${stats.queue_pending} pending`}
        accent="amber"
      />
      <MetricCard
      ...
      <MetricCard
        ...
        value={formatTokens(stats.token_spend_24h) ?? '-'}
        subtitle="extraction cost"
        accent="blue"
      />
      <MetricCard
        label="System Health"
