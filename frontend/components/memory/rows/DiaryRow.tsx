  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className={clsx(
            'text-[11px] font-semibold uppercase px-2.5 py-1 rounded border',
            config.color,
          )}
        >
          {config.label}
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {entry.what_worked.map((item, i) => (
                      <li
                        key={i}
                        className="text-sm text-slate-300 pl-4 relative before:absolute before:left-0 before:content-['•'] before:text-emerald-500"
                      >
                        {item}
                      </li>
                    ))}
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {entry.what_failed.map((item, i) => (
                      <li
                        key={i}
                        className="text-sm text-slate-300 pl-4 relative before:absolute before:left-0 before:content-['•'] before:text-rose-500"
                      >
                        {item}
                      </li>
                    ))}
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {entry.user_corrections.map((item, i) => (
                      <li
                        key={i}
                        className="text-sm text-slate-300 pl-4 relative before:absolute before:left-0 before:content-['•'] before:text-amber-500"
                      >
                        {item}
                      </li>
                    ))}
