              ...
              <div className="max-h-[400px] overflow-y-auto">
                {loading ? (
                  ...
                  <div className="p-8 text-center">
                    ...
                    <p className="text-slate-600 text-xs mt-1">No pending notifications</p>
                  </div>
                ) : (
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <Icon
                            className={clsx("w-5 h-5 mt-0.5 flex-shrink-0", severityColors[notification.severity])}
                          />
                            ...
                            <div className="flex items-center gap-2">
                              <span
                                className={clsx(
                                  ...
                                  notification.status === "pending" ? "text-slate-200" : "text-slate-400"
                                )}
                              >
                                {notification.title}
                              </span>
