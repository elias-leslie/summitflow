...
CANONICAL_BROWSE_SRC="${HOME}/summitflow/scripts/browse"
...
ln -sfnT "${CANONICAL_BROWSE_SRC}" "${BIN_DIR}/browse"
chmod +x "${WRAPPER_SRC}" "${CANONICAL_BROWSE_SRC}" "${REAPER_SRC}"
...
echo "browse wrapper: ${BIN_DIR}/browse"
