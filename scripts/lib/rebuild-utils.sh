...
build_frontend() { local d="$PROJECT_DIR/frontend"; [ ! -d "$d" ] && d="$PROJECT_DIR"; cd "$d" || return 1; log "Building..."; pnpm build --silent 2>&1 | tail -5 && log_success "Built" || { log_error "Build failed"; return 1; }; }
