...
export function NoteEditorHistoryView({ versions, loadingVersions, onClose, onRevert }: NoteEditorHistoryViewProps) {
    return (
        <div className="flex flex-col h-full min-w-0 bg-slate-900">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                {!loadingVersions && versions.length === 0 && <div className="px-4 py-6 text-center text-xs text-slate-600">No versions yet</div>}
