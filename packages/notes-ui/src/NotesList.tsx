...
export function NotesList({ activeTab, scopeFilter, selectedId, onSelect }: NotesListProps) {
    ...
    return (
        <div className="flex flex-col h-full border-r border-slate-700/50" style={{ width: '30%', minWidth: 180, maxWidth: 280, backgroundColor: '#0f172a' }}>
            {/* Search */}
            <div className="px-2 pt-2 pb-1.5">
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="Search..."
                        className="w-full pl-8 pr-2 py-1.5 bg-slate-800/50 border border-slate-700/50 rounded-md text-xs text-slate-300 placeholder:text-slate-600 outline-none focus:border-[var(--color-phosphor-500,#00f5ff)]/40 focus:ring-1 focus:ring-[var(--color-phosphor-500,#00f5ff)]/15 transition-all"
                    />
                </div>
            </div>
            ...
            {/* List */}
            <div className="flex-1 overflow-y-auto min-h-0" style={{ backgroundColor: '#0f172a' }}>
                {isLoading ? (
            ...
            <div className="px-2 py-2 border-t border-slate-800/50">
                <button
                    ...
                    className={clsx(
                        'w-full flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200',
                        'border border-dashed border-slate-700/60 text-slate-500',
                        'hover:border-[var(--color-phosphor-500,#00f5ff)]/30 hover:text-[var(--color-phosphor-400,#33f7ff)] hover:bg-[var(--color-phosphor-500,#00f5ff)]/5',
