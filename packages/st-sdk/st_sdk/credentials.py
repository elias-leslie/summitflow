"""Credential loading for owner commands that call Agent Hub."""
...
def _read_env_local() -> dict[str, str]:
    """Read and cache approved Agent Hub identity fields from ~/.env.local."""
...
def load_credentials(default_source: str = "st-cli") -> tuple[str, str]:
    """Return the Agent Hub client id and request source."""
